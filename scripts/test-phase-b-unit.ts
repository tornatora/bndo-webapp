...
const g1 = answerGroundedMeasureQuestion('Resto al Sud copre software?');
...
const g2 = answerGroundedMeasureQuestion('una SRL già attiva può accedere a Resto al Sud?');
...
const g3 = answerGroundedMeasureQuestion('qualcosa di non misura?');
assert(g3 === null, 'non-measure returns null');
passed++;

// --- Prudent or generic answer for odd question
const g4 = answerGroundedMeasureQuestion('Resto al Sud 2.0 vale per Marte?');
