      ...
      <main>
        <section className="hero">
          <div className="hero-content">
            ...
            <h1>Partecipare ad un BNDO non &egrave; mai stato cos&igrave; semplice</h1>
            <p className="lead">
              Partecipare ad un bando di finanza agevolata in maniera semplice, veloce, ordinata e{' '}
              <span className="lead-highlight">100% digitale</span>.
            </p>
            <div className="cta-group">
              <a href="#processo" className="btn-primary">
