  ...
  return (
    <section id="loginScreen" className="login-hero">
      <div className="login-content">
        ...
        <form action={routes.api.authLogin} method="post" className="login-form">
          ...
          {isAdminMode ? (
            ...
            <p style={{ marginTop: '12px', fontSize: '14px', color: 'var(--text-light)' }}>
              ...
              <Link href={routes.auth.forgotPassword} style={{ color: 'var(--navy)', fontWeight: 600 }}>
                Recuperala qui
              </Link>
              .
            </p>
          ...
          {!isAdminMode ? (
            <p style={{ marginTop: '16px', fontSize: '14px', color: 'var(--text-light)' }}>
              ...
              <Link href={routes.auth.register} style={{ color: 'var(--navy)', fontWeight: 600 }}>
                Registrati
              </Link>
            </p>
          ) : null}
