...
validate_supabase_env() {
  ...
  if [ ${#missing_keys[@]} -gt 0 ]; then
    echo "Prima di creare il demo, completa queste chiavi in .env.local:"
...
echo "Creo un cliente demo (serve app attiva su localhost:3000)..."
...
echo "Se vedi \"success\": true, ora apri http://localhost:3000/login"
